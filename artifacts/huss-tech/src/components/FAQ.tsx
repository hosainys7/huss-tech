...
export default function FAQ() {
  ...
  return (
    <section
      ...
      className="py-24"
      style={{
        background: "radial-gradient(ellipse 70% 50% at 80% 50%, rgba(67,8,8,0.08) 0%, transparent 60%), #0D0D0D",
      }}
    >
          ...
          {faqs.map((faq, i) => (
            <motion.div
              ...
              style={openIndex === i ? {
                ...
                boxShadow: "0 0 32px rgba(67,8,8,0.3)",
              } : {
            ...
            >
              ...
              >
                <span className="text-sm font-semibold transition-colors"
                  style={{ color: openIndex === i ? "rgba(230,170,55,0.95)" : "rgba(255,255,255,0.82)" }}>
                  {faq.question}
                </span>
                <motion.span
                  ...
                  className="shrink-0"
                  style={{ color: openIndex === i ? "rgba(230,170,55,0.8)" : "rgba(255,255,255,0.3)" }}
                >
                  <ChevronDown size={18} />
                </motion.span>
              </button>
